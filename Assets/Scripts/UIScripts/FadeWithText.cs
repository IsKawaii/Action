...
public class FadeWithText : MonoBehaviour
{
    ...
    private bool compFadeIn = false, compFadeOut = false;
    public ScenarioManager scenarioManager;
    public ScenarioScript BeforeFadeinText, AfterFadeinText;
    ...
    {
        scenarioManager.ReadScenarioBook(BeforeFadeinText);
        if(fadeIn || fadeOut)
        {
            return;
        }
    ...
    private void FadeInComplete()
    {
        ...
        fadeIn = false;
        compFadeIn = true;
        scenarioManager.ReadScenarioBook(AfterFadeinText);
        if (bgmManager != null)
        {
